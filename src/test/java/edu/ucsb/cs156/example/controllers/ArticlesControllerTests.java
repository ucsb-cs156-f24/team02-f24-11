...
public class ArticlesControllerTests extends ControllerTestCase{
    ...
    public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
            ...
            when(articleRepository.findById(eq("7"))).thenReturn(Optional.of(article));
            ...
            verify(articleRepository, times(1)).findById(eq("7"));
    ...
    public void test_that_logged_in_user_can_get_by_id_when_the_id_does_not_exist() throws Exception {
            ...
            when(articleRepository.findById(eq("7"))).thenReturn(Optional.empty());
    ...
    public void logged_in_user_can_get_all_articles() throws Exception {
            ...
            expectedArticles.addAll(Arrays.asList(article1));
    ...
    public void admin_can_delete_an_article() throws Exception {
            ...
            when(articleRepository.findById(eq("15"))).thenReturn(Optional.of(article1));
            ...
            // assert
            verify(articleRepository, times(1)).findById("15");
    ...
    public void admin_tries_to_delete_non_existant_article_and_gets_right_error_message()
            ...
            when(articleRepository.findById(eq("15"))).thenReturn(Optional.empty());
    ...
    public void admin_can_edit_an_existing_article() throws Exception {
            ...
            when(articleRepository.findById(eq("67"))).thenReturn(Optional.of(articleOrig));
            ...
            // assert
            verify(articleRepository, times(1)).findById("67");
    ...
    public void admin_cannot_edit_article_that_does_not_exist() throws Exception {
            ...
            when(articleRepository.findById(eq("67"))).thenReturn(Optional.empty());
