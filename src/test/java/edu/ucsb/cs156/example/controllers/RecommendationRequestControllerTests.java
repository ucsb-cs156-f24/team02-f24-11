...
public class RecommendationRequestControllerTests extends ControllerTestCase{
        ...
        public void logged_in_user_can_get_all_recommendationrequests() throws Exception {
                ...
                RecommendationRequest recommendationRequest2 = RecommendationRequest.builder()
                                .requesterEmail("sample2@gmail.com")
        ...
        public void an_admin_user_can_post_a_new_recommendationrequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/RecommendationRequest/post?requesterEmail=sample1@gmail.com&professorEmail=sample1@gmail.com&explanation=test1&dateRequested=2022-01-03T00:00:00&dateNeeded=2022-01-03T00:00:00&done=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_recommendationrequest() throws Exception {
                ...
                RecommendationRequest recommendationRequestOrig = RecommendationRequest.builder()
                                .requesterEmail("orig@gmail.com")
                                .professorEmail("orig@gmail.com")
                                .explanation("orig")
                                .dateRequested(ldt1)
                                .dateNeeded(ldt1)
                                .done(true)
                ...
                RecommendationRequest recommendationRequestEdited = RecommendationRequest.builder()
                                .requesterEmail("edited@gmail.com")
                                .professorEmail("edited@gmail.com")
                                .explanation("edited")
                                .dateRequested(ldt2)
                                .dateNeeded(ldt2)
                                .done(false)
