...
public class RecommendationRequestWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_recommendationrequest() throws Exception {
        ...
        page.getByTestId("RecommendationRequestForm-requesterEmail").fill("sample@gmail.com");
        page.getByTestId("RecommendationRequestForm-professorEmail").fill("test@gmail.com");
        page.getByTestId("RecommendationRequestForm-explanation").fill("test explanation");
        page.getByTestId("RecommendationRequestForm-dateRequested").fill("2024-11-03T12:00");
        page.getByTestId("RecommendationRequestForm-dateNeeded").fill("2024-11-03T12:00");
        ...
        page.getByTestId("RecommendationRequestForm-professorEmail").fill("newtest@gmail.com");
        page.getByTestId("RecommendationRequestForm-submit").click();

        assertThat(page.getByTestId("RecommendationRequestTable-cell-row-0-col-professorEmail")).hasText("newtest@gmail.com");
