...
public class HelpRequestIT {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                HelpRequest helpRequest = HelpRequest.builder()
                                .requesterEmail("jonathanzhang@ucsb.edu")
                                .teamId("5")
        ...
        public void an_admin_user_can_post_a_new_restaurant() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                ...
                                .param("requesterEmail", "jonathanzhang@ucsb.edu")
                                .param("teamId", "5")
                                .param("tableOrBreakoutRoom", "5")
                ...
                HelpRequest responseHelpRequest = mapper.readValue(response.getResponse().getContentAsString(), HelpRequest.class);
                helpRequest.setId(responseHelpRequest.getId()); // Update expected with actual id
