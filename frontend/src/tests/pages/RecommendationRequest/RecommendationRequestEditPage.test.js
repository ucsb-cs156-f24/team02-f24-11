  ...
  describe("tests where backend is working normally", () => {
    ...
    beforeEach(() => {
      ...
      axiosMock.onPut("/api/RecommendationRequest").reply(200, {
        id: "17",
        requesterEmail: "newTest17@gmail.com",
        professorEmail: "newSample17@gmail.com",
        explanation: "new test explanation 17",
    ...
    test("Is populated with the data provided", async () => {
      ...
      expect(requesterEmailField).toHaveValue("test17@gmail.com");
      expect(professorEmailField).toHaveValue("sample17@gmail.com");
      expect(explanationField).toHaveValue("test explanation 17");
    ...
    test("Changes when you click Update", async () => {
      ...
      fireEvent.change(requesterEmailField, {
        target: { value: "newTest17@gmail.com" },
      });
      fireEvent.change(professorEmailField, {
        target: { value: "newSample17@gmail.com" },
      });
      fireEvent.change(explanationField, {
        target: { value: "new test explanation 17" },
      });
      ...
      expect(mockToast).toBeCalledWith(
        "Recommendation Request Updated - id: 17 requester email: newTest17@gmail.com",
      );
